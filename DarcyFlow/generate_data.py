...
for idx, name_method in enumerate(methods):
    data_folder_list.append(Path(name_method + "/data"))
...
for idx in range(len(methods)):
    plot_fun2d(
        true_fun, nx=200, show=False, path=results_folder_list[idx] / "true_fun.svg", \
        grid_on=False, package="matplotlib"
    )
    # plot_fun2d(true_fun, show=False, path=results_folder_list[idx] / "true_fun.svg")
